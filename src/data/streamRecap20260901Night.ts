...
export const streamRecap20260901Night: StreamRecap = {
  ...
  summary:
    "9月最初の夜配信。言葉を届ける難しさや、挑戦を通じて誰かの一歩を後押ししたいという思いを話しました。Paton投票の締め切りを迎え、2位で終えたことへの感謝と、3次審査への意気込みを伝えた回です。",
  highlights: [
    {
      timestamp: "0:00:29",
      title: "9月最初の配信",
    ...
    },
    {
      timestamp: "1:40:10",
      title: "3次審査へ、一緒に進む",
      body: "9月3日からの3次審査に向けて、本気で挑戦していることを伝えました。締めには、皆さんと一歩ずつ進んでいこうと呼びかけました。",
    },
  ],
  goals: [
