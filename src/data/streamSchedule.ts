 ...
 *   9/8朝は開始 07:30 を SHOWROOM next_live（epoch 1788820200）で確認し、
 *   終了 08:20 は 9/8未明の本人Instagram Story「明日の朝枠は7:30〜8:20」で確認。
 *   9/10・9/8昼は未定／なしなので入れない。9/8夜の本人表記 24:00-25:00 は
...
export const streamSchedule: StreamSlot[] = [
  ...
  { date: "2026-09-08", time: "07:30", endTime: "08:20" },
  {
    date: "2026-09-09",
    time: "00:00",
    endTime: "01:00",
