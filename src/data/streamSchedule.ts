 ...
 *   9/7 06:30〜07:30 と 22:00〜23:00 は本人X（2026-09-06）で確認。
 *   開始 06:30 は SHOWROOM next_live とも一致。ほかの 9/7 枠は書かない。
 *   9/10・9/8朝・9/8昼は入れない。9/8朝 07:00–08:00 は未実施／
 *   SHOWROOM next_live差し替え（https://www.showroom-live.com/r/circle2026_0734 、
 *   epoch 1788879600 = 2026-09-09 00:00 JST）。配信実施は確認していない。
 *   9/8夜の本人表記 24:00-25:00 は実時刻の 9/9 0:00 として入れる
 *   （`time` は 00:00–23:59 のみ）。next_live は開始 00:00 を確認し、
 *   終了 01:00 は本人表記 25:00 の既存値のまま。
...
export function upcomingSlots(
  ...
  return [...merged.values()]
    ...
    // 三次審査の本人枠は25件。12件だと後半がカレンダーから落ちる。
    .slice(0, 32);
}
