...
- provenance: `owner-provided`。SNSから再取得していない
- source date: `2026-09-01`。再生permalinkなし。`sourceUrl` は null
...
- 元投稿: `https://x.com/amis2_mh/status/2097322336387297549`（2026-09-08 22:53 JST）。オーナーが当該投稿のサイト掲載を明示指定。
...
- sourceDate / sourceUrlはnull、publishedはfalse。投稿日確認後にLatest / NEWSへ配線する。記事案は `docs/AVATAR-ACHIEVEMENT-STORY-DRAFT.md`。
