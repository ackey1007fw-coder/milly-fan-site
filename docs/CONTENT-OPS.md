...
- オーナーから3配信の記事化・LIVE STREAM掲載を依頼されたうち、取得できた9月6日夜（31分27秒）・9月7日朝（44分40秒）を、それぞれ既存の共通カードへ追加。9月7日夜は素材取得未完了のため記事を作っていない。
